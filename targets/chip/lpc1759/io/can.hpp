#ifndef KLIB_LPC1759_CAN_HPP
#define KLIB_LPC1759_CAN_HPP
...
namespace klib::lpc1759::io::periph::detail::can {
    enum class mode {
        rd,
        td,
    };
...
namespace klib::lpc1759::io::periph::lqfp_80 {
    template <
